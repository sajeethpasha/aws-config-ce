...
if df is not None:
    ...
    # Calculate the product_cost for each date and line_item_product_code
    df['product_cost'] = df.groupby(['date', 'line_item_resource_id'])['line_item_unblended_cost'].transform('sum')
